    ...
    <x-nav-link href="{{ route('faculties.index') }}" :active="request()->routeIs('faculties.index')">
        <x-slot name="icon">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7H8m8 4H8m-3 4h14M5 20h14a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v14a1 1 0 001 1z"/>
            </svg>
        </x-slot>
        {{ __('Faculties') }}
    </x-nav-link> 
